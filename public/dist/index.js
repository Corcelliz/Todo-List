...
(function () {
    ...
    var taskView = {
        getTodo: function (form) {
            var todoDesciption = form.todoDescription.value;
            form.reset();
            return new Todo(todoDesciption);
        },
    ...
    var TaskController = function (view) {
        ...
        (_a = document.getElementById("toggleMode")) === null || _a === void 0 ? void 0 : _a.addEventListener('click', handToggleMode);
